...
<body>
    ...
    <div class="container mt-4">
        <hr>
        <h2 class="text-center mb-4"><span class="text-primary">Peta Lokasi</span> Sekolah</h2>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8">
                <img src="/images/{{ $map->galleries[0]->images[0]->file }}" alt="{{ $map->title }}" style="max-width: 45rem">
            </div>
        </div>
    </div>
